...
- sessions: 3(+-1)h sessions where I explain a particular topic and solve an exercise with you on the projector, then you are given an exercise to solve on your own laptops while I am in the classroom to provide assistance.
...
Currently there are 4 sessions planned:
1. Git + Python and the data science ecosystem of libraries for Python (pandas, etc.) **19.10.2023 @ 14.00 in P04**
2. Web scraping
3. Docker
4. SQL
